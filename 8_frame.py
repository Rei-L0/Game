...
# 배경 이미지 불러오기
background = pygame.image.load('C:/Users/qkrdu/Desktop/Game/background.png')

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load('C:/Users/qkrdu/Desktop/Game/character.png')
...
# 적 캐릭터
enemy = pygame.image.load('C:/Users/qkrdu/Desktop/Game/enemy.png')
...
# 시작 시간 정보
start_ticks = pygame.time.get_ticks()  # 현재 tick 을 받아 옴
